    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://tse2.mm.bing.net/th/id/OIP.s3x79zW0bKRaTfItjRj9KgHaHa?pid=Api&P=0&h=220" alt="" />
            </div>
...
// Functional Component with the arrow function
//not using key is unacceptable
//using index as key is a bad practise but use is as last option
const Body = () => {
    return (
        <div className="body">
